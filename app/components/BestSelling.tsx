...
const BestSelling = () => {
    ...
    return (
        <section className="best_selling_sec padding overflow-hidden">
            <div className="container">
                <div className="mb-[3.75rem]">
                    <div className="flex items-end justify-between">
                        <div>
                            <h2 className="text-[4rem] font-bold text-black mb-6">Bestselling Products</h2>
                            <p className="text-black">Most loved by our customers across India</p>
                        </div>
